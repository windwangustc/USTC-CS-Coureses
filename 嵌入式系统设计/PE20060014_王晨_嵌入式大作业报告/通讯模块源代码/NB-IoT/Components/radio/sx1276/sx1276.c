...
/*!
 * \brief warm Resets the SX1276
 */
void SX1276WarmReset( void );
    ...
    case MODEM_LORA:
        {
            ...
            if( SX1276.Settings.LoRa.FreqHopOn == true )
            {
                ...
                SX1276Write( REG_LR_DIOMAPPING1, ( SX1276Read( REG_LR_DIOMAPPING1 ) & RFLR_DIOMAPPING1_DIO0_MASK & RFLR_DIOMAPPING1_DIO2_MASK  ) | RFLR_DIOMAPPING1_DIO0_00 | RFLR_DIOMAPPING1_DIO2_00 );
            }
            else
            {
                SX1276Write( REG_LR_IRQFLAGSMASK, //RFLR_IRQFLAGS_RXTIMEOUT |
                ...
                // DIO0=RxDone
                SX1276Write( REG_LR_DIOMAPPING1, ( SX1276Read( REG_LR_DIOMAPPING1 ) & RFLR_DIOMAPPING1_DIO0_MASK ) | RFLR_DIOMAPPING1_DIO0_00 );
            }
    ...
    case MODEM_LORA:
        {
            if( SX1276.Settings.LoRa.FreqHopOn == true )
            {
                ...
                SX1276Write( REG_LR_DIOMAPPING1, ( SX1276Read( REG_LR_DIOMAPPING1 ) & RFLR_DIOMAPPING1_DIO0_MASK & RFLR_DIOMAPPING1_DIO2_MASK ) | RFLR_DIOMAPPING1_DIO0_01 | RFLR_DIOMAPPING1_DIO2_00 );
            }
            else
            {
                SX1276Write( REG_LR_IRQFLAGSMASK, RFLR_IRQFLAGS_RXTIMEOUT |
                ...
                // DIO0=TxDone
                SX1276Write( REG_LR_DIOMAPPING1, ( SX1276Read( REG_LR_DIOMAPPING1 ) & RFLR_DIOMAPPING1_DIO0_MASK ) | RFLR_DIOMAPPING1_DIO0_01 );
...
{
    // Set RESET pin to 0
    GpioInit( &SX1276.Reset, kGpioLORARESET, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 1 );

    // Wait 10 ms
    delayMS( 10 );

    // Configure RESET as input
    GpioInit( &SX1276.Reset, kGpioLORARESET, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL, 1 );
...
{
    // Set RESET pin to 0
    GpioInit( &SX1276.Reset, kGpioLORARESET, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );

    // wait at least 100 us, now is 1 millisecond
    delayMS( 1 );
