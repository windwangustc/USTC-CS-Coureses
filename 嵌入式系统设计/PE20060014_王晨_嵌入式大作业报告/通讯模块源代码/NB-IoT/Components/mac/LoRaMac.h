 ...
 *
 * \author    Daniel J盲ckle ( STACKFORCE )
 *
 ...
 */
#define RECEIVE_DELAY1                              10

/*!
 * Class A&B receive delay 2 in ms
 */
#define RECEIVE_DELAY2                              20

/*!
 * Join accept receive delay 1 in ms
 */
#define JOIN_ACCEPT_DELAY1                          4900
...
typedef union uMibParam
{
     ...
     */
    MulticastParamsNV_t * MulticastList;
    /*!
     * System overall timing error in milliseconds. 
     *
...
extern uint8_t LoraPadLoadFlag;
